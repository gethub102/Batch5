  ...
  <div>
    <div class="container">
      <nav class="navbar navbar-dark bg-primary">
        <a class="navbar-brand active" style="color: aliceblue;" href="index.jsp">Home</a>
        <a class="navbar-brand" style="color: aliceblue;" href="add-employee.jsp">Add Employee</a>
